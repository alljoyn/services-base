...
set ALLJOYN_ANDROID_JAR_DIR=C:\Users\HiggnsWin\dev\alljoyn\core\alljoyn\build\android\arm\debug\dist\java\jar
set ALLJOYN_ANDROID_LIB_DIR=C:\Users\HiggnsWin\dev\alljoyn\core\alljoyn\build\android\arm\debug\dist\java\lib
set ANDROID_HOME=C:\Users\HiggnsWin\AppData\Local\Android\android-sdk
set ALLJOYN_BASE_BUILD_DIR=C:\Users\HiggnsWin\dev\alljoyn\services\base
set ALLJOYN_CORE_BUILD_DIR=C:\Users\HiggnsWin\dev\alljoyn\core\alljoyn
...
:copyAlljoynSharedObject
    call:copyToDir %ALLJOYN_CORE_BUILD_DIR%\alljoyn_java\bin\libs\liballjoyn_java.so .\libs\armeabi\ "failed to copy liballjoyn_java.so" %ERROR%
exit /B %OK%
...
:buildOnboardingSamples
    ...
    echo Building OnboardingManager sample
    call:executeFuncInDir buildOnboardingManager %ONBOARDING_SAMPLES_ROOT%\OnboardingManager\android 
...
:buildOnboardingAboutConfServer
    ...
    call:copyAlljoynOnboardingJar
    call:copyAlljoynSharedObject
    call:copyToDir %ALLJOYN_CORE_BUILD_DIR%\build\android\%CPU%\%VARIANT%\dist\config\jar .\libs\ "Failed to copy android config jars" %ERROR%
    ant || (
