...
/**
 * This class implements {@link Clock} interface and realizes AllJoyn communication
 * with this clock.
 */
class ClockBusObj extends BaseClockBusObj implements Clock {
    ...
    /**
     * Constructor
     * @param clock Clock events delegate. This clock receives all the {@link org.allseen.timeservice.server.Clock}
     * related events.
     */
    ClockBusObj(org.allseen.timeservice.server.Clock clock) throws TimeServiceException {
        ...
        AboutServiceImpl.getInstance().addObjectDescription(getObjectPath(), new String[]{Clock.IFNAME});
    }
    ...
    protected void release() {
        ...
        if ( about.isServerRunning() ) {
            ...
            Log.d(TAG, "Remove object description of: " + Clock.IFNAME);
            about.removeObjectDescription(getObjectPath(), new String[]{Clock.IFNAME});
        }
    }
}
