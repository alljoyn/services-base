...
/**
 * This class implements {@link AlarmFactory} interface and realizes AllJoyn communication
 * with this AlarmFactory
 */
class AlarmFactoryBusObj implements AlarmFactory {
    ...
    /**
     * Alarm factory to be notified with {@link org.allseen.timeservice.server.AlarmFactory}
     * related messages
     */
    ...
    /**
     * Constructor
     * @param alarmFactory {@link org.allseen.timeservice.server.AlarmFactory} handler
     * @throws TimeServiceException Is thrown if failed to create {@link AlarmFactoryBusObj}
     */
     ...
     * @throws TimeServiceException Is thrown if failed to create {@link AlarmFactoryBusObj}
     */
    AlarmFactoryBusObj(org.allseen.timeservice.server.AlarmFactory alarmFactory, String description, String language,
        ...
        AboutServiceImpl.getInstance().addObjectDescription(objectPath, new String[]{AlarmFactory.IFNAME});
    ...
    void release() {
        ...
        if ( about.isServerRunning() ) {
            ...
            Log.d(TAG, "Remove object description of: '" + AlarmFactory.IFNAME + "'");
            about.removeObjectDescription(objectPath, new String[]{AlarmFactory.IFNAME});
        }
    }
