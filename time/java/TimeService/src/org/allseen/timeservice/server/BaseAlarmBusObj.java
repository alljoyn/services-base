...
/**
 * This is the base class for all the classes implementing {@link Alarm} interface.
 * Extend this class to handle AllJoyn communication with this {@link Alarm}.
 * Most of the {@link Alarm} related calls delegated to the {@link org.allseen.timeservice.server.Alarm}
 * object.
 */
...
public abstract class BaseAlarmBusObj /*implements Alarm*/ {
    private static final String TAG = "ajts" + BaseAlarmBusObj.class.getSimpleName();

    /**
     * Alarm to be notified with the {@link org.allseen.timeservice.server.Alarm} related calls
     */
     ...
     * @param alarm  {@link org.allseen.timeservice.server.Alarm} delegate
     * @param parentObj Parent object path if the object was created via {@link AlarmFactory}
     * @param needAnnounce If the object was created via {@link AlarmFactory} no need to Announce
     ...
     */
    void init(org.allseen.timeservice.server.Alarm alarm, String parentObj, boolean needAnnounce, String[] notAnnounced,
        ...
        //No need to send announcement if this Alarm object was created with AlarmFactory
        if ( needAnnounce ) {
     ...
     * @throws TimeServiceException if {@link org.allseen.timeservice.server.Alarm} hasn't been created yet
     */
