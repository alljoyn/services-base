 ...
 */
static QStatus
Crypto_GetRandomBytes(uint8_t* buf, const size_t count)
{
...
QStatus
CertificateUtil::GenerateIdentityCertificate(const ECCPublicKey& publicKey,
...
QStatus
CertificateUtil::GenerateMembershipCertificate(const ECCPublicKey& publicKey,
                                               const GUID128& group,
...
QStatus
CertificateUtil::IssueCertificate(const Crypto_ECC& issuerKeyPair,
...
QStatus
CertificateUtil::GenerateCA(const Crypto_ECC& caKeyPair, const String& caCN, CertificateX509& cert)
{
...
QStatus
CertificateUtil::GenerateCertificate(const String& subjectCN,
