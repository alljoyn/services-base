...
public interface OnboardingTransport extends BusObject
{
     ...
     * If authType parameter is invalid then the AllJoyn error code org.alljoyn.Error.OutOfRange will be returned
     * @param ssid
     * @param passphrase
     * @param WPA2_AUTO = -3, WPA_AUTO = -2, any = -1, Open = 0 , WEP = 1, WPA_TKIP = 2, WPA_CCMP = 3, WPA2_TKIP = 4, WPA2_CCMP = 5, WPS = 6
     * @throws BusException
     */
    ...
    /**
     * Scan all the WiFi access points in the onboardee's proximity.  
     * Some device may not support this feature.  
     * @throws BusException if feature is unsupported, AllJoyn error code org.alljoyn.Error.FeatureNotAvailable will be returned in the AllJoyn response.
     */
