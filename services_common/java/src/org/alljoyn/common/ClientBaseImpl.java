...
public abstract class ClientBaseImpl implements ClientBase {
    ...
    public ClientBaseImpl(String peerName,
                          ...
                          short port) {
        this(peerName, bus, serviceAvailabilityListener, objectPath, port, interfaceClassArr);
    }
    ...
    private ClientBaseImpl(String peerName,
        ...
        if (!interfaceClassesValid(interfaceClassArr)) {
            throw new IllegalArgumentException(
                    "InterfaceClass array can't be empty, or contain null"
            );
        }
    ...
    private boolean interfaceClassesValid(Class<?>[] interfaceClassArr) {
        if (interfaceClassArr == null || interfaceClassArr.length == 0) return false;
        for (Class<?> clz : interfaceClassArr) {
    ...
    /**
     * @see org.alljoyn.common.ClientBase#initBus(org.alljoyn.bus.BusAttachment)
     */
    @Override
    ...
    /**
     * @see org.alljoyn.common.ClientBase#getVersion()
     */
    @Override
    ...
    protected ProxyBusObject getProxyObject() throws BusException {
        if (!m_isConnected) {
            throw new BusException(
                    "Session is not connected, need to check isConnected, and reconnect."
            );
        }
    ...
    /**
     * @see org.alljoyn.common.ClientBase#getPeerName()
     */
    @Override
    ...
    /**
     * @see org.alljoyn.common.ClientBase#getSessionId()
     */
    @Override
    ...
    /**
     * @see org.alljoyn.common.ClientBase#disconnect()
     */
    @Override
    ...
    /**
     * @see org.alljoyn.common.ClientBase#connect()
     */
    @Override
    ...
    /**
     * @see org.alljoyn.common.ClientBase#isConnected()
     */
    @Override
